 ...
 * apidoc:0.11.1 http://www.apidoc.me/flow/group/0.0.8/anorm_2_x_parsers
 */
package io.flow.group.v0.anorm.conversions {
  ...
  object Json {
    ...
    object Local {
      ...
      implicit val columnToExpandableUser: Column[io.flow.group.v0.models.ExpandableUser] = parser { _.as[io.flow.group.v0.models.ExpandableUser] }
    }
